...
import { StartupFormData } from './startup-profile-form';

type TechStackInputInputProps = {
  control: Control<StartupFormData>;
};

const TechStackInputInput = ({ control }: TechStackInputInputProps) => {
  const [newSkill, setNewSkill] = useState<string>('');

  const {
    field: { value, onChange },
  } = useController<StartupFormData>({
    name: 'skills',
    control,
  });
...
export default TechStackInputInput;
